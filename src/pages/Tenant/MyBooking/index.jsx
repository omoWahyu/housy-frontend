...
import Modal from "../../../components/Common/PayBookingModal";
						...
						<div className='d-flex justify-content-between'>
							<div className={css.CardLeft}>
								...
								<div className='d-flex gap-3 align-items-center'>
									<div className='pe-4'>
										<h2>{user.idRooms.name}</h2>
										<p style={{ width: "19.5rem" }}>
											{user.idRooms.streetAddress},{" "}
											{user.idRooms.districtAddress}, {user.idRooms.townAddress}
										</p>
										{user.payment === "" ? (
											<span className={css.Badge}>Waiting Payment</span>
										) : (
											<span className={css.Badge}>{user.payment}</span>
										)}
									</div>
									<div
										style={{ width: "14rem" }}
									...
									<div className=''>
										<div>
											...
											<ul>
												{user.idRooms.amenities.map((x, k) => {
													return (
